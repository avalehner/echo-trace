  ...
  return (
    <div className={styles['year-menu-container']}>
      ...
      >
        ...
        {Array.from({ length: 77 }, (_, i) => 2026 - i).map(
          (
            year //Array.from() creates an array using the first param given, second param is a map function that transforms the array as it builds it
          ) => (
